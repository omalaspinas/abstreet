...
if [ ! -f data/input/N47W123.hgt ]; then
	get_if_needed \
		https://dds.cr.usgs.gov/srtm/version2_1/SRTM1/Region_01/N47W123.hgt.zip \
		data/input/N47W123.hgt.zip;
	unzip -d data/input data/input/N47W123.hgt.zip;
	rm -f data/input/N47W123.hgt.zip;
fi
...
for poly in `ls ../data/input/polygons/`; do
	...
	RUST_BACKTRACE=1 cargo run $release -- \
		...
		--elevation=../data/input/N47W123.hgt \
